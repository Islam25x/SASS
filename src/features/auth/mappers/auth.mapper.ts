...
import type { AuthSession, RegisterResult } from "../domain/auth.types";
...
export function mapLoginDtoToToken(data: unknown): string {
  return parseLoginResponseDto(data).token;
}

export function mapLoginDtoToSession(data: unknown, user: User): AuthSession {
...
export function mapRegisterDtoToResult(data: unknown): RegisterResult {
